...
object ChatLogs : Table("ChatLogs") {
    ...
    val chatMode = customEnumeration("chat_mode", sql = "text", toDb = DbChatMode::id, fromDb = DbChatMode::fromId)
    val chatResult = customEnumeration("chat_result", sql = "text", toDb = ChatResult::id, fromDb = ChatResult::fromId)
...
object GameInstances : Table("GameInstances") {
    ...
    val removalReason = customEnumeration("removal_reason", sql = "text", toDb = GameRemovalReason::id, fromDb = GameRemovalReason::fromId)
...
object Partnerships : Table("Partnerships") {
    ...
    val status = customEnumeration("status", sql = "text", toDb = PartnerStatus::id, fromDb = PartnerStatus::fromId)
...
object Punishments : Table("Punishments") {
    ...
    val punishmentType = customEnumeration("punishment_type", sql = "text", toDb = PunishmentType::id, fromDb = PunishmentType::fromId)
